...
const AppliedCampaigns = ({ campaign, userId, alreadyApplied }) => {
                  ...
                  <ul className="list-none space-y-4">
                    {tasks.length > 0 ? (
                      tasks.map((task, index) => (
                        <li key={index} className="bg-gradient-to-r from-yellow-100 to-yellow-50 p-4 rounded-xl shadow-sm animate-fadeInUp" style={{ animationDelay: `${index * 100}ms` }}>
                          <div className="mb-1">
