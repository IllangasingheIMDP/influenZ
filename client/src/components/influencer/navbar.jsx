...
const Navbar = () => {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    if (searchInput.trim()) {
      router.push(`/influencer/search?q=${encodeURIComponent(searchInput.trim())}`);
    }
  };
    ...
    <nav className="w-full bg-white border-b-2 border-gray-200">
      ...
      <div className="max-w-screen-xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <a href="/influencer" className="text-gray-700 text-base font-medium font-['Poppins'] hover:text-gray-900">
            Home
          </a>
